import { faGitAlt, faGithub, faInstagram, faInstagramSquare, faLinkedin, faLinkedinIn, faTwitter } from "@fortawesome/free-brands-svg-icons";

export const SteliosRouselakis = {
    name: 'Rouselakis Stelios',
    jobTitle: 'Software Development Tech Lead',
    websiteUrl: 'https://s.rouselakis.com',
    ...
    socials: [
        ...
        {
            icon: faGithub,
            link: 'https://github.com/Ov3r1d3',
            id: 's-github'
        },        {
            icon: faInstagram,
            link: 'https://www.instagram.com/s.rouselakis/',
            id: 's-instagram'
        },
        {
            icon: faTwitter,
            link: 'https://twitter.com/rouselakis',
            id: 's-twitter'
        }
    ],
